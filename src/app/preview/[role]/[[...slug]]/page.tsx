      ...
      <section className="mt-8" aria-labelledby="preview-content-title">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <h3 className="mt-3 text-xl font-bold">هنوز داده‌ای برای نمایش وجود ندارد</h3>
            <p className="mt-3 text-sm leading-7 text-dena-muted">
              نمایش این قسمت پس از پیاده‌سازی هویت، مجوزهای سمت سرور و اتصال به دادهٔ مجاز فعال خواهد شد.
            </p>
          </Card>
          <Card>
